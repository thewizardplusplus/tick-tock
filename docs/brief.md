...
Вычисление аргументов обеих команд выполняется синхронно и до обработки самих команд. Таким образом все побочные эффекты этого вычисления возникнут так же до обработки команд.
