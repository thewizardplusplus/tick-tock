...
| 6         | `<`        | меньше                                 | левая           | nil/числа/списки | `__lt__`          |
| 6         | `<=`       | меньше или равно                       | левая           | nil/числа/списки | `__le__`          |
| 6         | `>`        | больше                                 | левая           | nil/числа/списки | `__gt__`          |
| 6         | `>=`       | больше или равно                       | левая           | nil/числа/списки | `__ge__`          |
| 7         | `==`       | равно                                  | левая           | любые            | `__eq__`          |
| 7         | `!=`       | не равно                               | левая           | любые            | `__ne__`          |
| 8         | `&&`       | конъюнкция                             | левая           | любые            | —                 |
| 9         | `\|\|`     | дизъюнкция                             | левая           | любые            | —                 |
| 10        | `:`        | определение списка из головы и хвоста  | правая          | любой + список   | `__cons__`        |
