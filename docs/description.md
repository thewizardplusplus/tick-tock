...
| 7         | `<`        | меньше                                 | левая           | nil/числа/списки | `__lt__`          |
| 7         | `<=`       | меньше или равно                       | левая           | nil/числа/списки | `__le__`          |
| 7         | `>`        | больше                                 | левая           | nil/числа/списки | `__gt__`          |
| 7         | `>=`       | больше или равно                       | левая           | nil/числа/списки | `__ge__`          |
| 8         | `==`       | равно                                  | левая           | любые            | `__eq__`          |
| 8         | `!=`       | не равно                               | левая           | любые            | `__ne__`          |
| 9         | `&&`       | конъюнкция                             | левая           | любые            | —                 |
| 10        | `\|\|`     | дизъюнкция                             | левая           | любые            | —                 |
| 11        | `:`        | определение списка из головы и хвоста  | правая          | любой + список   | `__cons__`        |
