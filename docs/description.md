...
| 2         | `-`        | унарный минус                          | правая          | числа          | `__neg__`  |
...
| 5         | `<`        | меньше                                 | левая           | любой          | `__lt__`   |
| 5         | `<=`       | меньше или равно                       | левая           | любой          | `__le__`   |
| 5         | `>`        | больше                                 | левая           | любой          | `__gt__`   |
| 5         | `>=`       | больше или равно                       | левая           | любой          | `__ge__`   |
| 6         | `==`       | равно                                  | левая           | любой          | `__eq__`   |
| 6         | `!=`       | не равно                               | левая           | любой          | `__ne__`   |
| 7         | `&&`       | конъюнкция                             | левая           | любой          | —          |
| 8         | `\|\|`     | дизъюнкция                             | левая           | любой          | —          |
