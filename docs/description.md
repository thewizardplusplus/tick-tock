...
| 8         | `<`        | меньше                                 | левая           | nil/числа/списки | `__lt__`          |
| 8         | `<=`       | меньше или равно                       | левая           | nil/числа/списки | `__le__`          |
| 8         | `>`        | больше                                 | левая           | nil/числа/списки | `__gt__`          |
| 8         | `>=`       | больше или равно                       | левая           | nil/числа/списки | `__ge__`          |
| 9         | `==`       | равно                                  | левая           | любые            | `__eq__`          |
| 9         | `!=`       | не равно                               | левая           | любые            | `__ne__`          |
| 10        | `&&`       | конъюнкция                             | левая           | любые            | —                 |
| 11        | `\|\|`     | дизъюнкция                             | левая           | любые            | —                 |
| 12        | `:`        | определение списка из головы и хвоста  | правая          | любой + список   | `__cons__`        |
