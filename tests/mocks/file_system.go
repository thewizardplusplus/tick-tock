...
func (_m *FileSystem) Chmod(name string, mode os.FileMode) error {
...
func (_m *FileSystem) Chtimes(name string, atime time.Time, mtime time.Time) error {
...
func (_m *FileSystem) Create(name string) (afero.File, error) {
	ret := _m.Called(name)
...
func (_m *FileSystem) Open(name string) (afero.File, error) {
	ret := _m.Called(name)
...
func (_m *FileSystem) OpenFile(name string, flag int, perm os.FileMode) (afero.File, error) {
...
func (_m *FileSystem) Rename(oldname string, newname string) error {
